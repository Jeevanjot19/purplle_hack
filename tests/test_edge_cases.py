...
def test_group_entry_creates_one_event_per_track_on_entry_camera():
    ...
    assert [event["event_type"] for event in first + second] == ["ENTRY", "ENTRY"]
    assert len(registry.get_active_track_ids()) == 2
